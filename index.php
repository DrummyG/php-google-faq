...
$questions=[
    ...
    [
        ...
        "titleTwo" => "Stabilire il paese associato al tuo account",
        "textTwo" => [
...
<body>
    ...
    <?php
        ...
        <?php foreach($value["paragraph"] as $keyTwo => $valueTwo){ ?>
               <p>
               <?php echo $valueTwo; ?>
            </p>
            ...
            if($value["chek"] == true){ ?>
                <ul class="numbers">
                    <?php 
                        foreach($value["list"] as $pallini => $lettere){  ?>
                        <li>
                ...
                <h2>
                <?php echo $value["titleTwo"]; ?> 
                </h2>
                <?php 
                    foreach($value["textTwo"] as $t){ ?>
                        <p>
                        <?php echo $t; ?>
                        </p>
                        <?php    }
